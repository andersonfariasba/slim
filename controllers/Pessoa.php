	...
	class Pessoa{
		...
		*/
		function __construct(){
			$this->PDO = new \PDO('mysql:host=localhost;dbname=erp', 'root', ''); //Conexão
		...
		*/
		public function listar(){
			global $app;
			$sth = $this->PDO->prepare("SELECT * FROM clientes");
			$sth->execute();
		...
		*/
		public function nova(){
			...
			*/
			$sth = $this->PDO->prepare("INSERT INTO clientes (".implode(',', $keys).") VALUES (:".implode(",:", $keys).")");
